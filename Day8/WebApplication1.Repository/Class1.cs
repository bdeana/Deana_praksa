...
{
    public class Class1R : IRepositoryCommon
    {
        ...
        public async Task<List<Person>> Get(Sorter sorter = null, Pager pager = null, PersonFilter studentFilter = null) // SqlConnection connection)
        {
            ...
            string filter = Filter.FilterLike(personFilter.Filter);
            //SqlConnection connection = new SqlConnection("Data Source = laptop-oao02np6\\sqlexpress;Initial Catalog = deana; Integrated Security = True");
            using (connection)
            {
