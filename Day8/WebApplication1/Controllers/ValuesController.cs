...
using WebApplication1Model.Common;
...
namespace WebApplication1.Controllers
{
    ...
    public class ValuesController : ApiController
    {
        ...
        [HttpGet] 
        [Route("api/Person")]
        public async Task<HttpResponseMessage> Get([FromUri] Pager pager, [FromUri] Sorter sorter, [FromUri] PersonFilter peraon Filter) // SqlConnection connection)
        {
            //SqlConnection connection = new SqlConnection("Data Source = laptop-oao02np6\\sqlexpress;Initial Catalog = deana; Integrated Security = True");
            List<Person> list_Person = await iService.Get(sorter, pager, personFilter);
